...
void sendMessage() {
  String msg = mensagemEnviada; //"1.1.1.1.0.255.1.0.255.255.1."; // 1rx ou tx, 2luminaria, 3modo, 4adaptar, 5movimento, 6intencidadePWM, 7tempoTransição, 8ajusteMin, 9ajusteMax, 10ajusteLumens, 11tempoMovimento
